...
- [🚀 Full Kubernetes Guide](K8S/K8S-README.md) - Complete deployment guide with examples
...
- [🚀 Guide Kubernetes Complet](K8S/K8S-README.md) - Guide de déploiement complet avec exemples
...
For comprehensive Kubernetes deployment documentation, see the dedicated guide:

📖 **[Complete K8S Documentation / Documentation K8S Complète](K8S/K8S-README.md)**

The K8S directory contains all Kubernetes manifests and a detailed bilingual guide covering:
